<header id="page-topbar">
                <div class="navbar-header">
                    ...
                    <div class="d-flex">
                     ...
                     $profile = App\Models\Client::find($id);
                     @endphp
                        <div class="dropdown d-inline-block">
                            <button type="button" class="btn header-item bg-light-subtle border-start border-end" id="page-header-user-dropdown"
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src="{{ (!empty($profile->photo)) ? url('upload/client_photo/'.$profile->photo) : url('upload/no_image.jpg')}} "
                                    alt="Header Avatar">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item" href="{{route('client.profile')}}"><i class="mdi mdi mdi-face-man font-size-16 align-middle me-1"></i> Profile</a>
                                 ...
                                 <a class="dropdown-item" href="{{route('client.change.password')}}"><i class="mdi mdi mdi-face-man font-size-16 align-middle me-1"></i> Change Password</a>
                                 <div class="dropdown-divider"></div>
